...
// Config handlers
func GetAllConfig(db *gorm.DB) fiber.Handler {
...
func UpdateConfig(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
		varConf := c.Params("var_conf")
...
// Model handlers
func GetAllModels(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
		var models []Model
...
func CreateModel(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
...
func GetModel(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
...
func UpdateModel(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
		tableCode := c.Params("table_code")
...
func DeleteModel(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
		tableCode := c.Params("table_code")
		var model Model
		if err := db.Where("table_code = ?", tableCode).First(&model).Error; err != nil {
...
func GetAllModelDetails(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
...
func CreateModelDetail(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
...
func GetModelDetail(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
...
func UpdateModelDetail(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
		modelDetailCode := c.Params("model_detail_code")
...
func DeleteModelDetail(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
		modelDetailCode := c.Params("model_detail_code")
		var modelDetail ModelDetail
		if err := db.Where("model_detail_code = ?", modelDetailCode).First(&modelDetail).Error; err != nil {
...
// Generate handler
func GenerateGo(db *gorm.DB) fiber.Handler {
	return func(c *fiber.Ctx) error {
